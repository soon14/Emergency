...
//  动画页面名称
FOUNDATION_EXPORT NSString *const AnimationView_name;
//  动画页面描述字段   看得见  联得上  呼得应  调得动
FOUNDATION_EXPORT NSString *const AnimationView_info;
//  应急城市编码
...
/*****工程状态信息保存区域*****/
// 登录状态
FOUNDATION_EXPORT NSString *const LoginState;
