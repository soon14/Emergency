...
NSString *const USER_PASSWORD = @"13096349022";

NSString *const LoginState    = @"LoginState";
#if yaAn
//http://183.221.221.204:45002/APP/
/*  雅安定义区  */
...
NSString *const AnimationView_name = @"雅安市旅游\n应急指挥管理平台";

NSString *const AnimationView_info = @"看得见  联得上  呼得应  调得动";
...
/*  泰州定义区  */
//http://123.207.16.245/APP/
NSString *const POST_URL = @"https://appapi.daqsoft.com/TZEmergency/";

NSString *const APPNAME  = @"泰州旅游综合监管平台";
