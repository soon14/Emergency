...
- (void)viewDidLoad {
    ...
    preLayerHeight = _SCREEN_HEIGHT - 64 - 120;
...
-(void)initCapture{
    ...
    btView.center = CGPointMake(SCREEN_WIDTH/2, preLayerHeight+60);
    ...
    finishBt = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 66, 24)];
    finishBt.center = CGPointMake(_SCREEN_WIDTH -20-33, _SCREEN_HEIGHT - 60-64);
    finishBt.layer.cornerRadius = 4;
    finishBt.layer.borderColor =[UIColor whiteColor].CGColor;
    finishBt.layer.borderWidth = 1;
    [finishBt setTitle:@"确 定" forState:UIControlStateNormal];
    ...
    UIButton *dismButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 66, 24)];
    dismButton.center = CGPointMake(20+33, _SCREEN_HEIGHT - 60-64);
    ...
    dismButton.titleLabel.font = [UIFont systemFontOfSize:14];
    ...
    [exporter exportAsynchronouslyWithCompletionHandler:^{
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (self.videoPathUrl) {
                ...
                self.videoPathUrl(mergeFileURL);
