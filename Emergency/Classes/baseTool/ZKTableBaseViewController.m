...
@interface ZKTableBaseViewController ()<ZKBaseClassViewModeDelegate,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation ZKTableBaseViewController
