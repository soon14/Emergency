...
//    //设置TintColor
//    UITabBar.appearance.tintColor = CYBColorGreen;
    
    self.tabBar.barTintColor = NAVIGATION_COLOR;
...
- (void)awakeFromNib {
    ...
    self.centerItem = items[2];
    self.centerItem.image = [self.centerItem.image imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    self.centerItem.selectedImage = [self.centerItem.selectedImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
}
@end
