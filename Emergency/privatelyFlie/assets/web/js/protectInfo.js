...
function protectData(info) {
    ...
    htmlData.showLoading();
    
    $.ajax({
           //提交数据的类型 POST GET
           type:"POST",
           //提交的网址
           url:"http://weather.service.geeker.com.cn/directlyInfo",
...
function endData(dic)
{
   
    $("#bar_chart").html("");
    $("#chart_addr").html("");
    
    var list = JSON.parse(dic);
    
    tdata = list.weatherInfo;
